...
namespace Infrastructure.Utils
{
    public static class FindElement
    {
        ...
        //public static IWebElement WaitForEfrat(this ISearchContext searchContext, string cssSelector)
        //{
        //    DefaultWait<ISearchContext> defaultWait = new DefaultWait<ISearchContext>(searchContext);
        //    defaultWait.Timeout = TimeSpan.FromSeconds(20);
        //    defaultWait.IgnoreExceptionTypes(typeof(StaleElementReferenceException), typeof(NoSuchElementException),
