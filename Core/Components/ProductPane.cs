...
namespace Infrastructure
{
    ...
    {
        private Button ContinueShoppingButton => new Button(Driver, ParentElement.FindElement(By.CssSelector(".continue")));
        private Button ProceedToCheckoutButton => new Button(Driver, ParentElement.FindElement(By.CssSelector("[title='Proceed to checkout']")));
